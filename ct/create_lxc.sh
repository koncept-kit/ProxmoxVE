#!/usr/bin/env bash
# File: create_lxc.sh
# Location: /ct/create_lxc.sh (in your koncept-kit repository)
# Purpose: Creates the LXC container and configures basic settings

# Copyright (c) 2021-2025 koncept-kit
# License: MIT
# https://github.com/koncept-kit/ProxmoxVE/raw/main/LICENSE
